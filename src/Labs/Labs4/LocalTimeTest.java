...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToNanoSec() {
         ...
         */
        return LocalTime.of(23, 7, 3).plus(100, ChronoUnit.MILLIS);
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        return lt.minus(Duration.ofHours(3).plus(30, ChronoUnit.MINUTES).plus(20, ChronoUnit.SECONDS).plus(200, ChronoUnit.MILLIS));
    }
